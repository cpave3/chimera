 ...
 * the full tier `SkillSource`. `.claude-*`, `.codex-*`, and `.agents-*` sources
 * map to `claude-compat` — they're cross-tool compatibility roots,
 * indistinguishable for activation display.
 */
